---
title: "Landscape geneticis - Melbourne"
author: "Bernd Gruber"
date: '`r Sys.Date()`'
output: 
...
poss <- gl.read.dart("./data/Possums_SNP.CSV", "./data/Possum_Covariate_DArT_180619.csv", probar = FALSE)
...
rb <- raster("./data/RiverBridges.tif")
...
## Project a raster and clip it to a certain area.

load the raster file [you need to know its current projection]
